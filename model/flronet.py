...
class AFNOLayer(nn.Module):
    def __init__(self, embedding_dim, img_size=(180, 360), patch_size=(20, 20)):
        super().__init__()
...
class PatchEmbed(nn.Module):
    def __init__(self, img_size=(180, 360), patch_size=(20, 20), in_chans=64, embed_dim=768):
        super().__init__()
...
class DePatchEmbed(nn.Module):
    def __init__(self, img_size=(180, 360), patch_size=(20, 20), out_chans=64, embed_dim=768):
        super().__init__()
        self.img_size = img_size
        self.patch_size = patch_size
